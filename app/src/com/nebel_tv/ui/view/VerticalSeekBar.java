...
public class VerticalSeekBar extends SeekBar {
	...
	private static final int THUMB_TEXT_PADDING = NebelTVApp.getContext().getResources()
			.getDimensionPixelSize(R.dimen.vertical_seek_bar__thumb_text_padding);
	...
	private Drawable writeOnDrawable(Drawable drawable, String text) {
		...
		pts[0] = bm.getWidth() / 2;
		pts[1] = thumbOrientation == ThumbOrientation.LEFT ? textWidth + THUMB_TEXT_PADDING : bm.getHeight() - THUMB_TEXT_PADDING;
