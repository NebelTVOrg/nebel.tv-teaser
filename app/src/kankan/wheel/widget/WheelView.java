...
public class WheelView extends View {
	...
	public static enum CenterImageAlignType {
	...
	private CenterImageAlignType centerImageAlignType = CenterImageAlignType.CENTER;
	...
	/**
	 * Set drawable for center selected item
	 */
	public void setCenterDrawableRes(int resId, CenterImageAlignType centerImageAlignType) {
		centerDrawable = getContext().getResources().getDrawable(resId);
		if (centerImageAlignType != null) {
			this.centerImageAlignType = centerImageAlignType;
		}
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int offsetY = centerDrawable.getIntrinsicHeight() / 2;
		int centerX = getWidth() / 2;
		int offsetX = centerDrawable.getIntrinsicWidth() / 2;
		int left;
		int right;
		switch (centerImageAlignType) {
		case ALIGN_LEFT:
			left = 0;
			right = centerDrawable.getIntrinsicWidth();
			break;
		case ALIGN_RIGHT:
			left = getWidth() - centerDrawable.getIntrinsicWidth();
			right = getWidth();
			break;
		default:
		...
		centerDrawable.setBounds(left, centerY - offsetY, right, centerY + offsetY);
	...
	private void createItemsLayout() {
		if (itemsLayout == null) {
			...
			itemsLayout.setBackgroundColor(Color.TRANSPARENT);
